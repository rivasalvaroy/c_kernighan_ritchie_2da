/* Nuestros getch y ungetch no manejan correctamente un EOF que se regresa. 
   Decida cuáles deben ser sus propiedades si se regresa un EOF, y des­pués
   realice su diseño */
#include <stdio.h>
...
int buf[BUFSIZE]; // buffer para ungetch -> ahora es de tipo int
int bufp = 0;
