/* Agregue órdenes para manipular variables. (Es fácil proporcio­nar veintiséis
   variables con nombres de una letra.) Añada una variable para el va­lor impreso
   más reciente (v) */
#include <stdio.h>
